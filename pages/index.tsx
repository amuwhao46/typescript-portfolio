...
export default function Home({
  ...
  return (
    <div className="scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-orange-500/80 h-screen overflow-x-hidden scroll-smooth bg-gray-100 dark:bg-neutral-900 dark:text-gray-100">
      <Head>
