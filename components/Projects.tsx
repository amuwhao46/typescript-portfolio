...
export default function Projects({ projects }: Props) {
  return (
    ...
    >
      ...
      <div className="relative flex w-full snap-x snap-mandatory overflow-y-hidden overflow-x-scroll scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-blue-500/80">
        {/* Projects */}
        {projects?.map((project) => (
          <div
            key={project._id}
            className="mt-32 flex w-screen flex-shrink-0 snap-center flex-col items-center justify-between space-y-5 rounded-lg p-10 md:w-[1000px] md:p-16"
          >
            <img
            ...
            <div className="flex max-w-6xl flex-col items-center justify-center space-y-6 rounded-2xl bg-white/60 p-5 dark:bg-neutral-800/60 md:mx-auto md:space-y-10 md:px-10">
              ...
              >
                <h4 className="rounded-2xl p-3 text-center text-4xl font-semibold transition-all ease-in-out hover:bg-gray-100/80 hover:text-blue-400 dark:hover:bg-neutral-700/80">
                  {project.title}
                </h4>
              </Link>
